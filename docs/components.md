...
| `ExportDialog` | What the graph produces, what will be written and what it costs, then the file — modal, per graph ([Q32](decisions.md), [Q41](decisions.md))     | S3.3, S3.6, S3.7 |
