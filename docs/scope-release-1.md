...
| Item      | Work                                                                                                                                                                                                                                                  | Feature        |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| **S0.1**  | ~~Tauri shell: one window per project, dialogs, drag & drop, file associations~~ — **done**; File and Help are native menus ([Q47](decisions.md)), ⌘N opens a window, and what is left of the in-window bar is the fonts errand and the update notice | infrastructure |
