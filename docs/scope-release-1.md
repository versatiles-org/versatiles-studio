...
| **S4.1**    | ~~Asset manager for fonts and sprite sets, plus the **Map · Assets** mode bar ([Q22](decisions.md))~~ — **done for fonts**; pinned in a compiled-in manifest, verified before install, never unpacked                              | G7             |
