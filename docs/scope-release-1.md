...
| Item        | Work                                                                                                                                                                                               | Feature        |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| **S4.2**    | Style pane, and the recipe the core owns — preset, options, per-layer overrides — on S2.8's undo stack ([Q36](decisions.md#q36--the-core-owns-the-styles-recipe-not-the-style)). Includes **S4.7** | infrastructure |
...
| **S4.7**    | ~~Put style edits on S2.8's undo stack rather than building a second one~~ — **folded into S4.2**; see above                                                                                       | G6             |
